...
export const brandGuidelines = {
  ...
  version: 'v2',
  colors: {
    background: { cssVar: '--site-bg', hex: '#F7F4EE' },
    surface: { cssVar: '--site-surface', hex: '#F2EEE6' },
    surfaceAlt: { cssVar: '--site-surface-alt', hex: '#ECE7DD' },
    textPrimary: { cssVar: '--site-text-primary', hex: '#1A2A3D' },
    textBody: { cssVar: '--site-text-body', hex: '#40556C' },
    textMuted: { cssVar: '--site-text-muted', hex: '#6F8299' },
    onDarkPrimary: { cssVar: '--site-on-dark-primary', hex: '#F9F5EE' },
    onDarkMuted: { cssVar: '--site-on-dark-muted', hex: '#D9CFBF' },
    accent: { cssVar: '--site-accent', hex: '#4071AA' },
    accentStrong: { cssVar: '--site-accent-strong', hex: '#2F5F99' },
    accentDeep: { cssVar: '--site-accent-deep', hex: '#244D7C' },
    primary: { cssVar: '--site-primary', hex: '#2F5F99' },
    primaryHover: { cssVar: '--site-primary-hover', hex: '#244F81' },
    ctaBg: { cssVar: '--site-cta-bg', hex: '#2F5F99' },
    ctaText: { cssVar: '--site-cta-text', hex: '#FCF8F1' },
    ctaHoverBg: { cssVar: '--site-cta-hover-bg', hex: '#244F81' },
    border: { cssVar: '--site-border', hex: 'rgba(29, 46, 68, 0.15)' },
    overlayStrong: { cssVar: '--site-overlay-strong', hex: 'rgba(10, 17, 26, 0.36)' },
    overlayText: { cssVar: '--site-overlay-text', hex: '#FAF7F0' },
