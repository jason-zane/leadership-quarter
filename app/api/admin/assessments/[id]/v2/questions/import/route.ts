...
import { importAdminAssessmentV2QuestionBankCsv } from '@/utils/services/admin-assessment-v2-question-bank'
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = await importAdminAssessmentV2QuestionBankCsv({
